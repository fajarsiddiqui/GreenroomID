    ...
    <div className="p-6 space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1 max-w-3xl">Baca hasil pembelajaran client, beri catatan yang jelas, lalu putuskan apakah perlu revisi, belum diterima, atau diterima secara editorial. Pembayaran belum diproses pada RB-02.</p>
        </div>
