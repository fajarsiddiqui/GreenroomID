...
function LandingPage({ onShowHowItWorks }) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start mb-16">
          <div className="pt-6">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl px-4 py-3 inline-block shadow-sm">
                <p className="text-xs text-gray-400 mb-1">Kontak Person</p>
                <a
                href="https://wa.me/62882006446617"
                target="_blank"
                rel="noreferrer"
          ...
          <div className="space-y-5">
            <div className="bg-white rounded-3xl shadow-sm p-5">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="font-bold text-gray-900">Statistik Platform</h3>
                  <p className="text-xs text-gray-400">Ringkasan aktivitas GreenroomID</p>
                </div>
              </div>
